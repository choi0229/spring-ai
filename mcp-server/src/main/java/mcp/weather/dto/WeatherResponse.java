...
public class WeatherResponse {
    ...
    private Float rainfallDay;
    private Float rainfallMonth;
    private Float rainfallIntensity;

    // 적설
    private Float snowDepth3h;
