...
public record WeatherRequest(
        ...
        @JsonPropertyDescription("날씨를 조회할 도시 이름. 지원 도시: Seoul(서울), Busan(부산)")
        String city,
    ...
    public WeatherRequest {
        ...
        if(unit == null || unit.isEmpty()){
            ...
            if(!unit.equals("celsius") && !unit.equals("fahrenheit")){
                throw new IllegalArgumentException("온도 단위는 'celsius' 또는 'fahrenheit");
            }
        }
    }

    /**
     * 편의 생성자 - unit 없이 city 만으로 생성
     */
